...
// 由 LCD Assistant (http://en.radzio.dxp.pl/bitmap_converter/) 生成
...
// ============================================================================
// 测试：LCD 风格数据显示 (128x64 OLED 模拟 0802 LCD)
// ============================================================================
...
void ssd1306_TestFonts2() {
    ...
    // 下划线
    uint8_t x1 = 6 * 16;
    uint8_t y1 = 4 + 24 + 8 + 24;
    ssd1306_FillRectangle(x1, y1, x1 + 16, y1 + 2, White);
...
void ssd1306_TestFPS() {
    ...
    ssd1306_WriteString("U:", Font_11x18, Black);
